          ...
          echo ' <tr>
                  ...
                  <td>
                    ...
                    <div class="btn-group">
                      ...
                      <button class="btn btn-warning btnEditarUsuario" idUsuario="'.$value["id"].'" data-toggle="modal" data-target="#modalEditarUsuario"><i class="fa fa-pencil" style="color:white"></i></button>
    ...
    <div class="modal-content" style="background-color:black;">
      ...
      <form role="form" method="post" enctype="multipart/form-data">
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <select class="form-control input-lg" name="nuevoPerfil" style="border-right: 2px solid #e3aa00;">
            ...
            <!-- ENTRADA PARA SUBIR FOTO -->
             ...
             <div class="form-group">
              ...
              <input type="file" class="nuevaFoto" name="nuevaFoto" style="color:white">
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-default pull-left" data-dismiss="modal" style="background-color:#474141;color: #ffffff;border-color: #474141;">Salir</button>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <form role="form" method="post" enctype="multipart/form-data">
        ...
        <div class="modal-body" style="background:#000000; color:white">
            ...
            <!-- ENTRADA PARA EL USUARIO -->
             ...
             <div class="form-group">
              ...
              <div class="input-group">
                ...
                <span class="input-group-addon" style="background:#000000; color:white"><i class="fa fa-key"></i></span> 

                <input type="text" style="background:#000000; color:white" class="form-control input-lg" id="editarUsuario" name="editarUsuario" value="" readonly>
        ...
        <div class="modal-footer" style="background:#000000;">
          ...
          <button type="button" class="btn btn-default pull-left" data-dismiss="modal" style="background-color: #3d3838;color: #fff;border-color: #3d3838;">Salir</button>
